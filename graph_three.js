...
d3.csv("https://smartrestart-2.glitch.me/assets/lastupdate.csv", function(data) {
  lastupdatestring=data[0]['lastupdate'];
});
//Read the data
d3.csv("https://smartrestart-2.glitch.me/assets/data.csv", function(data) {
...
values: data.map(function(d) {
  ...
  x.domain([parseTime(document.getElementById("xachsestart3").value),parseTime(document.getElementById("xachseende3").value)]);
...
var calc_ymax= d3.format(".1f")(d3.max(data, function(d) { return +(d.Dunkelziffer); }));
    ...
    //.call(z_axis);
     ...
     function update3(inputWert,welches) {
       x.domain([parseTime(document.getElementById("xachsestart3").value),parseTime(document.getElementById("xachseende3").value)]);
       switch(welches) {
...
d3.select("#xachseende3").on("input", function() {
  update3(+this.value,"xachseende");
});
